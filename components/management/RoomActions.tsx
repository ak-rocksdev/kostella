  ...
  return (
    <div className="mt-5 border-t border-line pt-5">
      ...
      {open === 'move-in' && (
        ...
        >
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <label>
              <span className={label}>Sewa disepakati</span>
              <Select
                variant="field"
              ...
              />
              <span className="mt-1.5 block text-[12px] text-ink-soft">
                Harga kamar sekarang {formatRupiah(room.rent)}. Yang tercatat di sini yang ditagih.
              </span>
            </label>
          </div>
          {note && (
      ...
      {open === 'tenant-rent' && tenant && (
        ...
        >
          <label className="basis-44">
            <span className={label}>Sewa {tenant.name}</span>
            <Select
              variant="field"
              label="Sewa penghuni"
              value={String(rent)}
          ...
          <label className="min-w-0 flex-1 basis-60">
            ...
            />
            <span className="mt-1.5 block text-[12px] text-ink-soft">
              Hanya penghuni ini. Harga kamar untuk penghuni berikutnya tidak berubah.
            </span>
          </label>
          <Confirm onCancel={close} />
        </form>
      ...
      {open === 'rent' && (
        ...
        >
          <label className="basis-44">
            <span className={label}>Harga kamar</span>
            <Select
              variant="field"
              label="Harga kamar"
              value={String(rent)}
